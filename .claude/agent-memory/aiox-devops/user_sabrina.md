---
name: user-sabrina
description: Sabrina (Almacura) is the project owner; in financial recovery, so she is cost-sensitive about paid tooling/subscriptions
metadata:
  type: user
---
...
See [[project-ads-mcp]] for the Pipeboard-removal work driven by this.
